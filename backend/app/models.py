...
class Zone(Base):
    ...
    polygon_coords = Column(JSON, nullable=False)  # List of [x, y] coordinates e.g. [[100,200],[300,200],[300,400],[100,400]]
...
class Incident(Base):
    ...
    status = Column(String(50), default="unacknowledged")  # 'unacknowledged', 'acknowledged', 'dismissed'
